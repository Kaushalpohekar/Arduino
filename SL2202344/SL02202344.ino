...
int tab2[] = {16,18,20,22,24,26,28,30,32,34,36,38}; 
const char* registerNames2[] = {
 "current_1","current_2","current_3","current","kw_1","kw_2","kw_3","kvar_1","kvar_2","kvar_3","kva_1","kva_2"};
